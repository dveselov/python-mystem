...
class Quality(IntEnum):
    ...
    Dictionary  = 0x00000000 # слово из словаря
    Bastard     = 0x00000001 # не словарное
    Sob         = 0x00000002 # из "быстрого словаря"
    Prefixoid   = 0x00000004 # словарное + стандартный префикс (авто- мото- кино- фото-) всегда в компании с Bastard или Sob
    Foundling   = 0x00000008 # непонятный набор букв, но проходящий в алфавит
    BadRequest  = 0x00000010 # доп. флаг.: "плохая лемма" при наличии "хорошей" альтернативы ("махать" по форме "маша")
    FromEnglish = 0x00010000 # переведено с английского
    ToEnglish   = 0x00020000 # переведено на английский
    Untranslit  = 0x00040000 # "переведено" с транслита
    Overrode    = 0x00100000 # текст леммы был перезаписан
    Fix         = 0x01000000 # слово из фикс-листа
